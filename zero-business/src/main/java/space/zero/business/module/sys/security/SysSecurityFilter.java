...
public class SysSecurityFilter extends AbstractSecurityInterceptor implements Filter {
    ...
    @Autowired
    private SysSecurityMetadataSource sysSecurityMetadataSource;

    public SysSecurityFilter(SysSecurityMetadataSource sysSecurityMetadataSource) {
        this.sysSecurityMetadataSource = sysSecurityMetadataSource;
    }
    ...
    public SecurityMetadataSource obtainSecurityMetadataSource() {
        return this.sysSecurityMetadataSource;
    }
}
